...
void DeleteAccountDialog::on_okBtn_clicked()
{
    ...
    CTC::getInstance()->postRPC( toJsonFormat( "id_wallet_check_passphrase", "wallet_check_passphrase", QStringList() << ui->pwdLineEdit->text()
                                               ));
...
void DeleteAccountDialog::jsonDataUpdated(QString id)
{
    if( id.startsWith( "id_wallet_check_passphrase") )
    {
        ...
        {
            CTC::getInstance()->postRPC( toJsonFormat( "id_wallet_account_delete", "wallet_account_delete", QStringList() << accountName
                                                       ));
